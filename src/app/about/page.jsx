      ...
      <div className="h-full overflow-scroll lg:flex" ref={containerRef}>
        ...
        <div className="p-4 sm:p-8 md:p-12 lg:p-16 xl:p-20 flex flex-col gap-16 md:gap-20 lg:gap-24 xl:gap-28 lg:w-2/3 lg:pr-0 xl:w-1/2">
          ...
          <div className="flex flex-col gap-12 justify-center">
            ...
            {/* BIOGRAPHY DESC */}
            <p className="text-lg">
              I'm <b>Ankit Kumar,</b> a Full-Stack & AI Engineer with <b>9+ years of experience</b> 
              building enterprise-grade digital solutions for <b>global BFSI, telecom, and banking clients.</b>
              I specialize in <b>React, Next.js, Tailwind CSS, Node.js, FastAPI, and Generative AI workflows,</b> creating scalable platforms that improve performance, user experience, and business efficiency.
            </p>
            {/* BIOGRAPHY QUOTE */}
            <span className="italic">
              "Where creativity meets engineering, meaningful products emerge."
            </span>
            {/* BIOGRAPHY SIGN SVG*/}
